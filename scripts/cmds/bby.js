...
module.exports.onChat = async ({ api, event }) => {
    try {
        ...
        if (event.type !== "message_reply" && hasTrigger) {
            ...
            const randomMessage = [
                " তুই একটা বলদ, তুই সিঙ্গেল এই মর 🤣😘 ",
                "neo amr boss k message daw 01853792282",
                "-ছোট বেলায় একটু সাবান খাইছিলাম🧼🤌তখন থেকেই মনটা পরিষ্কার,,",
                "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏",
                "𝗜 𝗹𝗼𝘃𝗲 𝘆𝗼𝘂__😘😘",
                "𝗕𝗯𝘆 𝗕𝗯𝘆 না করে আমার বস মানে, 𝗢𝗻𝗶𝗸 ,𝗢𝗻𝗶𝗸 ও তো করতে পারো😑?",
                "আমার সোনার বাংলা, তারপরে লাইন কি? 🙈",
                "🍺 এই নাও জুস খাও..!𝗕𝗯𝘆 বলতে বলতে হাপায় গেছো না 🥲",
                "হটাৎ আমাকে মনে পড়লো 🙄",
                "বাবু ডিনার করছো এটা বলার কেউ নাই 🥺,,তাই আর ডিনার করি না 🥺,,,,,রাতে খেয়ে শুয়ে পরি,,,😁🤣",
                "𝗔𝘀𝘀𝗮𝗹𝗮𝗺𝘂𝗹𝗮𝗶𝗸𝘂𝗺 🐤🐤",
